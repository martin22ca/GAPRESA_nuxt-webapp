<template>
  <div class='drawer w-60'>
    ...
    <aside class="w-60 h-screen bg-base-100 flex flex-col border-r-2 border-neutral">
      ...
      <div class="mt-auto items-center p-10">
        <label class="swap swap-rotate">
          <input v-model="theme" type="checkbox" @click="changeTheme" />
...
const changeTheme = () => {
  if (theme.value) colorMode.preference = 'light'
  else colorMode.preference = 'dark'
}
onMounted(() => {
  if (colorMode.value != 'ligth') theme.value = false
})
